...
class QuoteWidgetProvider : AppWidgetProvider() {
    ...
    override fun onDeleted(context: Context, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            prefs.edit()
                .remove("$prefix_collectionId")
                .remove("$prefix_currentIndex")
                .remove("$prefix_text")
                .remove("$prefix_status")
                .remove("$prefix_totalItems")
                .remove("$prefix_rotationMode")
                .remove("$prefix_textColor")
                .remove("$prefix_backgroundColor")
                .remove("$prefix_fontSize")
                .remove("$prefix_sizeCategory")
                .remove("$prefix_showProgress")
                .remove("flutter.$prefix_collectionId")
                .remove("flutter.$prefix_currentIndex")
                .remove("flutter.$prefix_text")
                .remove("flutter.$prefix_status")
                .remove("flutter.$prefix_totalItems")
                .remove("flutter.$prefix_rotationMode")
                .remove("flutter.$prefix_textColor")
                .remove("flutter.$prefix_backgroundColor")
                .remove("flutter.$prefix_fontSize")
                .remove("flutter.$prefix_sizeCategory")
                .remove("flutter.$prefix_showProgress")
                .apply()
        }

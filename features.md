...
- **Final Hardening Batch (2026-09-07):** `fix(final-hardening)` local — snapshot content-only (P0-1), reorder filter-safe (P1-1), `daily_item_id` (P1-2), setup rollback (P1-3), duplicate author (P2-1), dead-code verify (P2-2), guide no auto-pin (P2-3). 170/170 tests. Chi tiết: `result10.txt`.
